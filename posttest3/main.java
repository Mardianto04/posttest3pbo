...
//                    Asin.get(i).display();
                    System.out.println("Telur : " + Asin.get(i).getJenistelur());
                    System.out.println("Daging : " + Asin.get(i).getJenisdaging());
                    System.out.println("harga : " + Asin.get(i).getHarga());
                    System.out.println("==========================");
                }
                for (int i = 0; i < Manis.size(); i++) {
                    ...
                    System.out.println("No. " + (i+1));
//                    Asin.get(i).display();
                    System.out.println("Rasa : " + Manis.get(i).getRasa());
                    System.out.println("Toping : " + Manis.get(i).getToping());
                    System.out.println("harga : " + Manis.get(i).getHarga());
                    System.out.println("==========================");
                }
            } else if (menu == 3) {
                System.out.println("1. asin");
